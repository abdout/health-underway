  ...
  const formSections = [
    {
      ...
      content: (
        <section className="space-y-6">
          ...
          {/* <div className="flex flex-col gap-6 md:flex-row">
            <div className="flex-1">
              <Select
                ...
                onValueChange={val => form.setValue("identificationType", val as any)}
              >
          ...
          <div className="flex flex-col gap-6 md:flex-row">
            <div className="flex-1">
              <FileUploader files={form.watch("identificationDocument")} onChange={val => form.setValue("identificationDocument", val)} />
            </div>
          </div> */}
        </section>
      ),
  ...
  return (
    <Form {...form}>
      <form
        ...
        className="flex-1 space-y-12 pb-32" // Add pb-32 for bottom padding
      >
        {formSections[step].content}
        {/* Sticky button bar at bottom */}
        <div className="fixed bottom-0 left-0 w-full z-50 bg-background border-t border-border px-4 py-4 flex justify-between items-center shadow-md">
          <Button
            type="button"
            variant="outline"
