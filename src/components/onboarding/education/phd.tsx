...
const PhD = ({
  ...
  useEffect(() => {
    register('phdInstitution', { required: "Please choose university" });
    register('phdMajor', { required: "Please choose specialization" });
    register('phdCompletionYear', { required: "Please choose year" });
  }, [register]);
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm font-semibold mb-2">PhD Information:</p>
