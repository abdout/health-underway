...
const Professor = ({
  ...
  useEffect(() => {
    register('professorInstitution', { required: "Please choose university" });
    register('professorMajor', { required: "Please choose specialization" });
    register('professorCompletionYear', { required: "Please choose year" });
  }, [register]);
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm font-semibold mb-2">Professor Information:</p>
