  ...
  return (
    ...
    >
      ...
      <p className="text-sm font-semibold mb-2">
        Education Level<span className="hidden md:inline">:</span>
      </p>
      ...
      <div className="md:hidden w-full">
        ...
        >
          <SelectTrigger className="h-9 text-left" aria-label="Education Level">
            <SelectValue placeholder="Choose education level" />
          </SelectTrigger>
          <SelectContent className="text-left" position="popper" side="bottom" align="start">
            {educationLevels.map((level) => (
