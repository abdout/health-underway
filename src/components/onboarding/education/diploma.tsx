...
const Diploma = ({
  ...
  useEffect(() => {
    register('diplomaInstitution', { required: "Please choose university" });
    register('diplomaMajor', { required: "Please choose specialization" });
    register('diplomaCompletionYear', { required: "Please choose year" });
  }, [register]);
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm font-semibold mb-2">Diploma Information:</p>
