...
const Bachelor = ({
  ...
  useEffect(() => {
    register('bachelorInstitution', { required: "Please choose university" });
    register('bachelorMajor', { required: "Please choose specialization" });
    register('bachelorCompletionYear', { required: "Please choose year" });
  }, [register]);
  ...
  const bachelorSteps: SelectionStep[] = [
    ...
    },
    {
      ...
      emptyMessage: "No specializations available",
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm font-semibold mb-2">Bachelor's Information:</p>
        ...
        <div className={getContainerClass()}>
          ...
          <div className={getFieldStyle('year', 3)}>
            ...
            <SelectPopover
              ...
              displayValue={selectedBachelorYear?.label}
