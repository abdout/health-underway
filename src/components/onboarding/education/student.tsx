...
const Student = ({
  ...
  useEffect(() => {
    register('studentInstitution', { required: "Please choose university" });
    register('studentFaculty', { required: "Please choose specialization" });
    register('studentYear', { required: "Please choose year" });
  }, [register]);
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm font-semibold mb-2">Study Information:</p>
