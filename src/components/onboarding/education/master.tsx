...
const Master = ({
  ...
  useEffect(() => {
    register('masterInstitution', { required: "Please choose university" });
    register('masterMajor', { required: "Please choose specialization" });
    register('masterCompletionYear', { required: "Please choose year" });
  }, [register]);
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm font-semibold mb-2">Master's Information:</p>
