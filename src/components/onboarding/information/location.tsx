...
const Location = ({
  ...
  const locationSteps: SelectionStep[] = [
    ...
    },
    {
      ...
      placeholder: "Choose administrative unit",
      emptyMessage: "No administrative units available",
      getOptions: (prev) => {
  ...
  useEffect(() => {
    ...
    if (!hasExistingData) {
      ...
      register('currentAdminUnit', { required: "Please choose administrative unit" });
