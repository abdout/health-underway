...
function TelegramIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        d="M21.944 3.433a1.5 1.5 0 0 0-1.6-.217L2.7 10.36a1.5 1.5 0 0 0 .13 2.8l3.9 1.4 2.1 6.3a1.5 1.5 0 0 0 2.7.2l2.1-3.5 3.7 2.7a1.5 1.5 0 0 0 2.4-1l2-13a1.5 1.5 0 0 0-.086-.827zM10.5 19.5l-2-6 8.5-7.5-6.5 13.5zm7.5-2.5l-3.5-2.5 4.5-4-1 6.5z"
        fill="#229ED9"
      />
    </svg>
  );
  ...
  return (
    <div className="flex flex-row gap-6 items-center justify-center">
      ...
      <a href="https://wa.me/" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 256 258" className="hover:scale-110 transition-transform">
          <defs>
            <linearGradient id="logosWhatsappIcon0" x1="50%" x2="50%" y1="100%" y2="0%"><stop offset="0%" stopColor="#1faf38"/><stop offset="100%" stopColor="#60d669"/></linearGradient>
            <linearGradient id="logosWhatsappIcon1" x1="50%" x2="50%" y1="100%" y2="0%"><stop offset="0%" stopColor="#f9f9f9"/><stop offset="100%" stopColor="#fff"/></linearGradient>
          </defs>
      ...
      <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 256 209" className="hover:scale-110 transition-transform">
      ...
      <a href="https://telegram.org" target="_blank" rel="noopener noreferrer" aria-label="Telegram">
        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 256 256" className="hover:scale-110 transition-transform">
          <defs>
            <linearGradient id="logosTelegram0" x1="50%" x2="50%" y1="0%" y2="100%"><stop offset="0%" stopColor="#2aabee"/><stop offset="100%" stopColor="#229ed9"/></linearGradient>
          </defs>
      ...
      {/* Mastodon
      <a href="https://mastodon.social" target="_blank" rel="noopener noreferrer" aria-label="Mastodon">
        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 16 16" className="hover:scale-110 transition-transform">
