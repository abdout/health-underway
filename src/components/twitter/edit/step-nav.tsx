...
const steps = [
  ...
  { title: 'Attachments', route: 'attachment', link: '/dashboard/profile/edit/attachment', icon: 'attachment' },
  { title: 'Contact', route: 'contact', link: '/dashboard/profile/edit/contact', icon: 'contact' },
  { title: 'Information', route: 'information', link: '/dashboard/profile/edit/information', icon: 'information' },
  { title: 'Education', route: 'education', link: '/dashboard/profile/edit/education', icon: 'education' },
  { title: 'Contribution', route: 'contribute', link: '/dashboard/profile/edit/contribute', icon: 'contribute' },
  { title: 'Activity', route: 'activity', link: '/dashboard/profile/edit/activity', icon: 'activity' },
];
